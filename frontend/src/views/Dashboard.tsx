...
import { Container, Typography, Box, Grid, Paper, Divider, Fade, Grow, AppBar, Toolbar, ThemeProvider, CssBaseline } from '@mui/material';
...
export function Dashboard({ stompClient }: DashboardProps) {
    ...
    const handleDeviceDelete = (deletedDeviceId: string) => {
        removeDevice(deletedDeviceId); // Używamy akcji ze store
    };
